...
#   RETRIEVED_DOMAIN_FROM=experiment/zeroshot_retriever/Qwen3-0.6B.json \
#     ./script/run_tier1_oracle.sh                   # domain PREDICTED via retriever top-1 (non-oracle domain_filtered)
