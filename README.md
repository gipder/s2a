...
| 세팅 | Acc | EM | F1 |
|---|---|---|---|
| 152개 전체 | 69.3% | 43.8% | 62.5% |
| domain 필터링 | 83.1% | 50.6% | 69.0% |
| 실제 retriever @k=5 (1 epoch 학습) | 78.2% | 48.7% | 64.9% |
| oracle top-5 (GT 보장) | 97.4% | 59.5% | 73.7% |
| **논문 목표 (Qwen 8B)** | **77.1%** | **10.1%** | **19.3%** |

Acc는 4개 세팅 다 논문 목표(77.1%)와 비슷한 범위인데, **EM과 F1은 전부 논문보다 훨씬 높음**(EM
43.8~59.5% vs 목표 10.1%, F1 62.5~73.7% vs 목표 19.3%) — 4~6배 차이라 우연한 오차라고 보기
